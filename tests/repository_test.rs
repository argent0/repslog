...
async fn test_workout_flow() {
    ...
    // 4. Add Sets
    let s1 = repo.add_set(we_id, 1, Some(10), Some(60.0), None, None, Some(8.0), None, None, None, None, None, None, None, None, None, None, None).await.unwrap();
    let s2 = repo.add_set(we_id, 2, Some(10), Some(60.0), None, None, Some(8.5), None, None, None, None, None, None, None, None, None, None, None).await.unwrap();
    assert!(s1 > 0);
    assert!(s2 > 0);
