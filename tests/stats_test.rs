...
async fn test_stats_prs() {
    ...
    // Max weight set
    repo.add_set(we_id, 1, Some(10), Some(100.0), None, None, Some(9.0), None, None, None, None, None, None, None, None, None, None).await.unwrap();
    // Max reps set (different weight)
    repo.add_set(we_id, 2, Some(15), Some(80.0), None, None, Some(8.0), None, None, None, None, None, None, None, None, None, None).await.unwrap();
...
async fn test_stats_volume() {
    ...
    repo.add_set(we_id, 1, Some(10), Some(10.0), None, None, None, None, None, None, None, None, None, None, None, None, None).await.unwrap();
    // Volume: 12 * 10.0 = 120.0
    repo.add_set(we_id, 2, Some(12), Some(10.0), None, None, None, None, None, None, None, None, None, None, None, None, None).await.unwrap();
