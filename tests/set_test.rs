...
async fn test_set_numbering() {
    ...
    let ex_id = repo.add_exercise("Ex1", "cat", None, None, None, false, false).await.unwrap();
    ...
    repo.add_set(we_id, set1_num, Some(10), None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, false).await.unwrap();

    let set2_num = repo.get_next_set_number(we_id).await.unwrap();
    assert_eq!(set2_num, 2);
    repo.add_set(we_id, set2_num, Some(12), None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, false).await.unwrap();
}
...
async fn test_set_quick_logic() {
    ...
    let ex_id = repo.add_exercise("Pullups", "calisthenics", None, Some("bodyweight"), None, false, false).await.unwrap();
    let w_id = repo.create_workout(None, None, None, false).await.unwrap();
    ...
    let we_id = repo.add_workout_exercise(w_id, exercise.id, order, None, false).await.unwrap();
    repo.add_set(we_id, 1, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, false).await.unwrap();
